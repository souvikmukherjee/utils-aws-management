...
echo "📡 Creating PostgreSQL tunnel (localhost: -> jump box -> RDS:5432)..."
ssh -i "" -L :aws-management-dev-db-1752944212.c7y6uccm606w.ap-southeast-2.rds.amazonaws.com:5432 -N ec2-user@ &
POSTGRES_TUNNEL_PID=$!

echo "📡 Creating Redis tunnel (localhost: -> jump box -> Redis:6379)..."
ssh -i "" -L :aws-management-dev-redis-1752944212.zrxyak.0001.apse2.cache.amazonaws.com:6379 -N ec2-user@ &
REDIS_TUNNEL_PID=$!

echo ""
echo "✅ SSH tunnels established!"
echo "PostgreSQL: localhost:"
